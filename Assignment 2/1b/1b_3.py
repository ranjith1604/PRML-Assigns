...
for k in K:
    ...
    #print(X_valid)
    print("accuracy for k="+str(k)+" using GMM with diagonal covariance matrix on Training set is "+str(prob/tot*100))
    ...
    if k==4:
        ...
        plt.savefig('Confusion_train_3.png')
    ...
    #print(X_valid)
    print("accuracy for k="+str(k)+" using GMM with diagonal covariance matrix on validation set is "+str(prob/tot*100))
...
print("accuracy for k="+str(4)+" using GMM with diagonal covariance matrix on Testing set is "+str(prob/tot*100))
confuse=confusion_matrix(real,predicted)
...
plt.savefig('Confusion_test_3.png')
...
plt.xlabel('x1')
plt.ylabel('x2')
plt.title('Decision Region plot for GMM with k=4 for each class using diagonal covariance matrix')

plt.savefig('plot_GMM_Full_3.png')
plt.show()
